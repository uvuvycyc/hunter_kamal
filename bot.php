...
if(!file_exists('config.json')){
	$token = readline('Hi KAMAL Enter Token: ');
	$id = readline('Hi KAMAL Enter Id: ');
      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/GGG80G/13988",
                   'caption'=>'𝙏𝙝𝙞𝙨 𝘽𝙤𝙩 𝙋𝙧𝙤𝙜𝙧𝙖𝙢𝙚𝙙 𝘽𝙮 : @ACIXXZ 💙',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'اضافة حساب 👨🏻‍💻','callback_data'=>'login']],
                       [['text'=>"𝘿𝙚𝙫𝙚𝙡𝙤𝙥𝙚𝙧", 'url'=>"https://t.me/ACIXXZ"]],
                      ]
                  ])
              ]);   
          } 
if($text == '/help'){
              ...
              'video'=>"https://t.me/GGG80G/13988",
              'caption'=>'طرق السحبب🤘😂',
                      'reply_markup'=>json_encode([
                      'inline_keyboard'=>[                       
                       [['text'=>"𝙍𝙚𝙥𝙤𝙧𝙩 𝙋𝙧𝙤𝙗𝙡𝙚𝙢𝙨", 'url'=>"https://t.me/ACIXXZ"]],
                       ]
                       ])
                       ]);
    
              $bot->sendvoice([ 'chat_id'=>$chatId,
                  'voice'=>"https://t.me/GGG80G/13954",
                           'caption'=>'الصيد تضمن كيف😂🤘',
                ]);
                      $bot->sendvoice([ 'chat_id'=>$chatId,
                  'voice'=>"https://t.me/GGG80G/13988",
          	...
          	if($config['mode'] != null){
          		...
          		if($mode == 'addL'){
		              ...
		              $bot->editMessageText([
		                  'chat_id'=>$chatId,
		                  'message_id'=>$mid,
		                  'text'=>"صفحة التحكم في الاكونتات الوهميه 🛂",
...
اضغط في الاسفل لمراسله المطور 👇",
							'reply_markup'=>json_encode([
                  'inline_keyboard'=>[
                      [['text'=>'𝘿𝙚𝙫𝙚𝙡𝙤𝙥𝙚𝙧','url'=>'t.me/ACIXXZ']]
                  ]
							])
					]);
				}
