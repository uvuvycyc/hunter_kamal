...
$edit = bot('sendMessage',[
    ...
    'reply_markup'=>json_encode([
            'inline_keyboard'=>[
                ...
                [['text'=>"Gmail☢️☢️: $Gmail",'callback_data'=>'dfgfd'],['text'=>"Yahoo: $yahoo",'callback_data'=>'gdfgfd']],
                [['text'=>'MailRu☢️: '.$mailru,'callback_data'=>'fgd'],['text'=>'Hotmail: '.$hotmail,'callback_data'=>'ghj']],
                [['text'=>'Aol☢️: '.$aol,'callback_data'=>'fahmyaol']],
...
foreach ($users as $user) {
    ...
    if ($info != false and !is_string($info)) {
        ...
        $usern = $info['user'];
        $e = explode('@', $mail);
               if (preg_match('/(live|hotmail|outlook|yahoo|Yahoo|aol|Aol)\.(com)|(Gmail☢️☢️)\.(com)|(mail|bk|yandex|inbox|list)\.(ru)/i', $mail,$m)) {
